...
public class PasitheaBuilderFromService {
    ...
    public PasitheaBuilderFromService(){}
     ...
     */
    public PasitheaBuilderFromService setValues(Application application){
     ...
     */
    public PasitheaBuilderFromService setInitListener(onInitListener listener){
