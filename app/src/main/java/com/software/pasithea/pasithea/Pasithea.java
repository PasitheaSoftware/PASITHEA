...
/**
 * Pasithea main class to expose the internal functions to the developpers.
 ...
 * or execute an action once the initialization is done. For more details on the initialization check the PasitheaBuilder class.
 * @see PasitheaBuilder
